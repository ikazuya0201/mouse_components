...
macro_rules! impl_search_operator_test {
    ($name: ident: $size: ty, $input_str: expr, $goals: expr,) => {
        ...
        fn $name() {
            ...
            let agent: defaults::SearchAgent<
                Encoder,
                Encoder,
                IMU,
                Motor,
            ...
            let create_commander = |wall_storage| {
                ...
                let maze =
                    Maze::<_, _, _, MathFake>::new(wall_storage, pose_converter, wall_converter);
            ...
            let operator = SearchOperator::new(agent, commander, CommandConverter::default());
