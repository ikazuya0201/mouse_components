...
use components::{
    ...
    operators::simple_search_operator::SearchOperator,
    robot::Robot,
    simple_search_agent::SearchAgent,
...
impl_search_operator_test!(
    simple_search_operator_tests1: U4,
    "+---+---+---+---+
|               |
+   +---+---+   +
|   |       |   |
...
impl_search_operator_test!(
    simple_search_operator_tests2: U16,
    "+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
|                           |   |   |                           |
+   +---+---+---+   +---+   +---+---+   +---+   +---+---+---+   +
|   |           |   |                       |   |           |   |
...
impl_search_operator_test!(
    simple_search_operator_tests3: U4,
    "+---+---+---+---+
|               |
+   +---+---+   +
|   |       |   |
